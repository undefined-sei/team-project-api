...
// INDEX
// GET /message
router.get('/message', requireToken, (req, res, next) => {
  Message.find()
    .then(message => {
...
router.get('/message/:id', requireToken, (req, res, next) => {
...
// CREATE
// POST /message
router.post('/message', requireToken, (req, res, next) => {
...
router.patch('/message/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/message/:id', requireToken, (req, res, next) => {
  Message.findById(req.params.id)
    .then(handle404)
    .then(message => {
